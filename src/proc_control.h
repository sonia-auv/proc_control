...
class proc_control final
{
 ...
 public:
  ...
  struct B_proc_control_T {
    ...
    s_VA2YLuOkHrWNKQO7FEpyoH_proc_T m_m;
    real_T Jx_c[16900];
    real_T a[10400];
    real_T Jmv[10400];
    ...
    real_T b_C[3003];
    s_Ref0liQlfQOPmAop9i3aPH_proc_T q_g;
    real_T Sx_data[2730];
    real_T b_Sx[2730];
    ...
    real_T Bu[1848];
    s_j0X3urodUv3ospvkLXsspC_proc_T p_l;
    real_T y_data[1829];
    ...
    SL_Bus_proc_control_sonia_common_MpcInfo msg_c;// '<S114>/MATLAB Function'
    real_T b_D[390];
    SL_Bus_proc_control_sonia_common_MpcGains In1_o;// '<S229>/In1'
    SL_Bus_proc_control_sonia_common_MpcGains b_varargout_2_md;
    real_T b_A_m[338];
    ...
    real_T Selector_g[117];            // '<S204>/Selector'
    int32_T iC[226];
    real_T Bc_e[104];
    real_T Sum_f[104];
    real_T b_C_h[104];
    ...
    real_T b_Ac_data[81];
    real_T tau_data[81];
    real_T b_Ac_data_i[81];
    real_T work_data_o[81];
    real_T work_data_k[81];
    real_T tmp_data_ie[81];
    ...
    SL_Bus_proc_control_sensor_msgs_Imu b_varargout_2_b;
    SL_Bus_proc_control_sensor_msgs_Imu msg_c_c;// '<S91>/MATLAB Function'
    ...
    somzaGboVhDG7PNQS6E98jD_proc__T qpoptions_nc;
    int8_T As[64];
    int8_T Au_tmp[64];
    int8_T Au_tmp_p[64];
    real_T U_dk[8];
    real_T u_scale[8];                 // '<S137>/u_scale'
    real_T rtb_u_scale_o[8];
    real_T dv17[8];
    real_T umax_incr[8];
    real_T umin_incr[8];
    real_T b_Wu[8];
    ...
    real_T y_pi[7];
    real_T x_o[7];
    s_8RbNZtrzTH63iHAPCwMh6G_proc_T r_l;
    int32_T iv[13];
    SL_Bus_proc_control_geometry_msgs_Twist In1_od;// '<S300>/In1'
    real_T u[8];                       // '<S236>/ '
    SL_Bus_proc_control_geometry_msgs_Twist b_varargout_2_j;
    ...
    char_T b_zeroDelimTopic_n[37];
    char_T b_parameterName_data[36];
    char_T b_parameterName_data_i[36];
    char_T b_parameterName_data_l[36];
    char_T b_parameterName_data_i3[36];
    char_T b_parameterName_data_k[36];
    char_T b_parameterName_data_f[36];
    char_T b_parameterName_data_a[36];
    char_T b_parameterName_data_d[36];
    char_T b_parameterName_data_e[36];
    char_T b_parameterName_data_eh[36];
    char_T b_zeroDelimTopic_b[35];
    char_T b_zeroDelimTopic_a[34];
    char_T parameterName_data[34];
    char_T parameterName_data_i[34];
    char_T parameterName_data_f[34];
    char_T parameterName_data_j[34];
    char_T parameterName_data_o[34];
    char_T parameterName_data_fr[34];
    char_T parameterName_data_oy[34];
    char_T parameterName_data_l[34];
    char_T parameterName_data_lu[34];
    char_T parameterName_data_g[34];
    char_T b_zeroDelimTopic_d[33];
    quaternion_proc_control_T expl_temp_dv;
    ...
    char_T name_ew[30];
    char_T b_name_n[30];
    char_T b_zeroDelimTopic_ho[29];
    char_T b_zeroDelimTopic_hp[28];
    char_T b_zeroDelimTopic_f[27];
    char_T b_zeroDelimTopic_cy[26];
    char_T b_zeroDelimTopic_nn[26];
    boolean_T icf_i[26];
    boolean_T icf_f[26];
    emxArray_real_T_proc_control_T tmp_data_he;
    emxArray_real_T_proc_control_T tmp_data_kq;
    emxArray_real_T_proc_control_T b_H_data_h;
    emxArray_real_T_proc_control_T b_H_data_b;
    emxArray_real_T_proc_control_T Jmv_o;
    emxArray_real_T_proc_control_T Auf;
    emxArray_real_T_proc_control_T Jm_data_n;
    emxArray_real_T_proc_control_T tmp_data_mi;
    emxArray_real_T_proc_control_T Jm_data_k;
    emxArray_real_T_proc_control_T tmp_data_jk;
    emxArray_real_T_proc_control_T Jm_data_h;
    emxArray_real_T_proc_control_T tmp_data_f2;
    emxArray_real_T_proc_control_T I2Jm_data_d;
    emxArray_real_T_proc_control_T Kut_data;
    emxArray_real_T_proc_control_T Jm_data_l;
    emxArray_real_T_proc_control_T tmp_data_kg;
    emxArray_real_T_proc_control_T I2Jm_data_i;
    emxArray_real_T_proc_control_T Kut_data_h;
    emxArray_real_T_proc_control_T Jm_data_m;
    emxArray_real_T_proc_control_T tmp_data_gm;
    emxArray_real_T_proc_control_T Kut_data_l;
    emxArray_real_T_proc_control_T I2Jm_data_m;
    emxArray_real_T_proc_control_T Kut_data_n;
    emxArray_real_T_proc_control_T Kut_data_g;
    emxArray_real_T_proc_control_T Hv_data_d;
    emxArray_real_T_proc_control_T in4_data;
    emxArray_real_T_proc_control_T tmp_data_mq;
    ...
    char_T b_zeroDelimTopic_ai[22];
    char_T b_zeroDelimTopic_ji[22];
    ...
    int32_T b_k_h;
    int32_T i9;
    int32_T sizes_idx_0_n;
    int32_T c_k;
    int32_T d_k_k;
    int32_T i_bt;
    int32_T b_c_size;
    int32_T b_size_idx_0_o;
    int32_T i10;
    int32_T loop_ub_n;
    int32_T loop_ub_fi;
    int32_T Jx_idx_0;
    ...
    int32_T Ns_n;
    int32_T i_ov;
    int32_T b_this_MPC_tmax;
    int32_T b_this_MPC_tmin;
    int32_T i_da;
    int32_T loop_ub_hk;
    int32_T i33;
    int32_T i_h4;
    ...
    int32_T br;
    int32_T h_d;
    int32_T b_this_MPC_tmax_n;
    int32_T b_this_MPC_tmin_b;
    int32_T i_f;
    int32_T loop_ub_j;
    int32_T i40;
    int32_T i_hc2;
    ...
    int32_T i41;
    int32_T parameterName_size_idx_1_c;
    int32_T loop_ub_tmp_tmp_g;
    int32_T i42;
    int32_T newNumel_e;
    int32_T i_eq;
    int32_T i43;
    ...
    int32_T d_k1;
    int32_T ia_l;
    int32_T parameterName_size_idx_1_e;
    int32_T loop_ub_tmp_tmp_e;
    int32_T i47;
    int32_T i_ft;
    int32_T parameterName_size_idx_1_d;
    ...
    int32_T newNumel_es;
    int32_T i_nf;
    int32_T parameterName_size_idx_1_h;
    int32_T loop_ub_tmp_tmp_a;
    int32_T i50;
    int32_T parameterName_size_idx_1_b;
    int32_T loop_ub_tmp_tmp_k;
    int32_T i51;
    int32_T parameterName_size_idx_1_a;
    int32_T loop_ub_tmp_tmp_km;
    int32_T i52;
    int32_T parameterName_size_idx_1_p;
    int32_T loop_ub_tmp_tmp_o;
    int32_T i53;
    int32_T parameterName_size_idx_1_c4;
    int32_T loop_ub_tmp_tmp_kh;
    int32_T i54;
    int32_T parameterName_size_idx_1_hs;
    int32_T loop_ub_tmp_tmp_bv;
    int32_T i55;
    int32_T j_ez;
    int32_T i_co;
    int32_T y_om;
    ...
    uint8_T empty_non_axis_sizes_bn[2];
    ...
    boolean_T b_bool_b;
    boolean_T status_e;
    boolean_T nameExists_m;
    boolean_T nameExists_h;
    boolean_T nameExists_b;
    boolean_T nameExists_d;
    boolean_T nameExists_o;
    boolean_T nameExists_k;
    boolean_T nameExists_mr;
    boolean_T nameExists_f;
    boolean_T nameExists_ox;
    SL_Bus_proc_control_std_msgs_Bool b_varargout_2_i;
    SL_Bus_proc_control_std_msgs_Bool BusAssignment_k;
    SL_Bus_proc_control_std_msgs_UInt8 b_varargout_2_k;
    char_T b_name_n1;
    char_T b_name_fq;
    char_T b_name_m;
    char_T b_name_ia;
  ...
  struct DW_proc_control_T {
    ...
    real_T init_e;                     // '<S128>/MPC manager'
 ...
 private:
  ...
  boolean_T proc_contr_ParameterTree_get_pr(ros_ParameterTree_proc_contro_T *obj);
  void p_RosparamClass_extractionArray(real_T nbElements,
    emxArray_real_T_proc_control_T *array);
  void pro_emxEnsureCapacity_boolean_T(emxArray_boolean_T_proc_contr_T *emxArray,
    int32_T oldNumel);
  boolean_T proc_control_ifWhileCond(const emxArray_boolean_T_proc_contr_T *x);
  ...
  void proc_con_RosparamClass_getArray(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void proc_c_RosparamClass_getArray_p(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void proc__RosparamClass_getArray_pr(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[13], emxArray_real_T_proc_control_T *
    gainRequested);
  void proc_RosparamClass_getArray_pr3(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void pro_RosparamClass_getArray_pr35(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void pr_RosparamClass_getArray_pr351(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[13], emxArray_real_T_proc_control_T *
    gainRequested);
  void p_RosparamClass_getArray_pr351e(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void RosparamClass_getArray_pr351ew(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void RosparamClass_getArray_pr351ewp(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[13], emxArray_real_T_proc_control_T *
    gainRequested);
  void RosparamClass_getArra_pr351ewpk(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void RosparamClass_getArr_pr351ewpk3(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  void RosparamClass_getAr_pr351ewpk3k(RosparamClass_proc_control_T *b_this,
    real_T nbGains, const real_T actualGain[8], emxArray_real_T_proc_control_T
    *gainRequested);
  ...
  void proc_control_getRosparam_p(real_T initialMPC_nx, real_T initialMPC_ny,
    real_T initialMPC_nu, real_T initialMPC_Ts, real_T initialMPC_p, real_T
    initialMPC_m, real_T initialMPC_dts, real_T initialMPC_tmax, real_T
    initialMPC_tmin, const sj4ROHEH4aFW0Ul74HJ1BrG_proc__T initialMPC_thrusters,
    const real_T initialMPC_Xi[13], const real_T initialMPC_Ui[8], const
    s69z5j67qcMWJNVTaeqYm0F_proc__T initialMPC_trajectory, real_T
    initialMPC_targetReached_linear, real_T initialMPC_targetReached_angula,
    real_T initialMPC_targetReached_timeIn, const
    sw6XGAsqPRjEuE5AMiznTdG_proc__T *initialMPC_gains,
  ...
  void proc_TrajectoryManager_stepImpl(TrajectoryManager_proc_contro_T *b_this,
    ...
    *isReached);
  void proc_control_getRosparam(real_T initialMPC_nx, real_T initialMPC_ny,
    real_T initialMPC_nu, real_T initialMPC_Ts, real_T initialMPC_p, real_T
    initialMPC_m, real_T initialMPC_dts, real_T initialMPC_tmax, real_T
    initialMPC_tmin, const sj4ROHEH4aFW0Ul74HJ1BrG_proc__T initialMPC_thrusters,
    const real_T initialMPC_Xi[13], const real_T initialMPC_Ui[8], const
  ...
  void proc_co_emxFreeStruct_AuvConfig(AuvConfig_proc_control_pr_T *pStruct);
  void emxFreeStruct_MultiTrajectoryMa(MultiTrajectoryManager_proc_c_T *pStruct);
  void proc_c_emxFreeStruct_AuvConfig1(AuvConfig_proc_control_p_T *pStruct);
  void proc_c_emxFreeStruct_mpcManager(mpcManager_proc_control_T *pStruct);
  void proc_c_emxFreeStruct_AuvConfig2(AuvConfig_proc_control_T *pStruct);
  void proc_co_emxFreeStruct_TrimPlant(TrimPlant_proc_control_T *pStruct);
  void proc_co_emxInitStruct_AuvConfig(AuvConfig_proc_control_pr_T *pStruct);
  void emxInitStruct_MultiTrajectoryMa(MultiTrajectoryManager_proc_c_T *pStruct);
  void proc_c_emxInitStruct_AuvConfig1(AuvConfig_proc_control_p_T *pStruct);
  void proc_c_emxInitStruct_mpcManager(mpcManager_proc_control_T *pStruct);
  void proc_c_emxInitStruct_AuvConfig2(AuvConfig_proc_control_T *pStruct);
  void proc_co_emxInitStruct_TrimPlant(TrimPlant_proc_control_T *pStruct);
