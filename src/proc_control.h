...
class proc_control final
{
 ...
 public:
  ...
  struct B_proc_control_T {
    ...
    real_T b_SuJm[2080];
    real_T WySuJm[2080];
    real_T b_SuJm_p[2080];
    real_T WySuJm_c[2080];
    real_T Jmv_f[2080];
    real_T h[2016];
    s_oZGbvi5mjKKebHB9aR5DoG_proc_T QPObjective;
    real_T A[1859];                    // '<S140>/MATLAB Function2'
    real_T C[1859];                    // '<S140>/MATLAB Function2'
    real_T y_data_g[1845];
    real_T y_data_g1[1845];
    real_T work_data[1845];
    real_T work_data_m[1845];
    ...
    real_T dv2[1280];
    real_T I2Jm_l[1280];
    real_T WuI2Jm_o[1280];
    real_T dv3[1280];
    real_T B[1144];                    // '<S140>/MATLAB Function2'
    real_T b_Su1[1040];
    real_T Sum_b[1040];
    real_T b_Su1_n[1040];
    real_T b_tmp[1026];
    ...
    real_T b_A_l[625];
    real_T AA_h[625];
    SL_Bus_proc_control_std_msgs_Float64MultiArray In1_f;// '<S235>/In1'
    SL_Bus_proc_control_std_msgs_Float64MultiArray b_varargout_2_b;
    SL_Bus_proc_control_sonia_common_MpcInfo msg;// '<S110>/MATLAB Function'
    real_T b_Kx[400];
    real_T b_Kx_d[400];
    SL_Bus_proc_control_sonia_common_MpcGains In1_o;// '<S236>/In1'
    ...
    real_T b_x[147];
    real_T Dv[143];
    real_T Y[143];                     // '<S140>/MATLAB Function2'
    real_T X[143];                     // '<S140>/MATLAB Function2'
    real_T DX[143];                    // '<S140>/MATLAB Function2'
    real_T CA_j[143];
    real_T X_e[143];
    real_T b_X[143];
    real_T X_o[143];
    ...
    real_T Selector_o[117];            // '<S211>/Selector'
    real_T rtb_B_nh[104];
    real_T Sum_l[104];
    real_T b_C_p[104];
    real_T dHdx[91];
    ...
    real_T b_C_f[91];
    real_T y_i[91];
    real_T useq_a[88];                 // '<S172>/FixedHorizonOptimizer'
    real_T U_o[88];
    real_T b_U[88];
    real_T U_k[88];
    real_T U_i[88];
    ...
    real_T gfU[80];
    real_T y_m4[80];
    real_T Selector1_n[72];            // '<S211>/Selector1'
    ...
    real_T y_k[26];
    real_T b_xoff[25];
    real_T rtb_TmpSignalConversionAtMAT__n[25];
    ...
    real_T TmpSignalConversionAtMAT_lt[13];// '<S136>/Bus2Mux'
    real_T rows[13];
    real_T CA_i[13];
    real_T b_Wy[13];
    real_T b_C_d[13];
    ...
    somzaGboVhDG7PNQS6E98jD_proc__T qpoptions_c5;
    int8_T b_B_p[64];
    int8_T As[64];
    int8_T Au_tmp[64];
    int8_T Au_tmp_p[64];
    ...
    SL_Bus_proc_control_geometry_msgs_Pose In1_n;// '<S331>/In1'
    SL_Bus_proc_control_geometry_msgs_Pose b_varargout_2_c;
    SL_Bus_proc_control_geometry_msgs_Pose msg_i;// '<S93>/MATLAB Function'
    SL_Bus_proc_control_geometry_msgs_Pose msg_e;// '<S301>/MATLAB Function2'
    real_T z_f[7];
    ...
    char_T b_zeroDelimTopic_l[30];
    char_T b_zeroDelimTopic_lu[30];
    char_T b_zeroDelimTopic_g[29];
    char_T b_zeroDelimTopic_d[28];
    char_T b_zeroDelimTopic_dv[27];
    int8_T UnknownIn[27];
    char_T b_zeroDelimTopic_js[26];
    ...
    real_T v_f[3];
    real_T c_jz[3];
    real_T tmp_data_kl[3];
    char_T b_zeroDelimTopic_bn[23];
    char_T b_zeroDelimTopic_hm[23];
    char_T b_zeroDelimTopic_eg[22];
    char_T b_zeroDelimTopic_hn[22];
    char_T b_zeroDelimTopic_k[20];
    char_T b_zeroDelimTopic_jw[19];
    char_T b_zeroDelimTopic_oo[17];
    char_T b_zeroDelimTopic_cs[16];
    ...
    real_T zvelocity;                  // '<S239>/Discrete Transfer Fcn1'
    real_T Sum;                        // '<S269>/Sum'
    ...
    real_T scale_gh;
    real_T dotSY;
    SL_Bus_proc_control_std_msgs_UInt8 In1_i2;// '<S327>/In1'
    SL_Bus_proc_control_std_msgs_Float32 In1_e;// '<S74>/In1'
    SL_Bus_proc_control_std_msgs_Float32 In1_om;// '<S81>/In1'
    SL_Bus_proc_control_std_msgs_Bool In1_f1;// '<S330>/In1'
    SL_Bus_proc_control_std_msgs_Bool In1_cx;// '<S326>/In1'
  ...
  struct DW_proc_control_T {
    ...
    OpenLoopController_proc_contr_T obj_m;// '<S139>/MATLAB System'
    ...
    AddPose_proc_control_T obj_a;      // '<S302>/MATLAB System1'
    ...
    ros_slroscpp_internal_block_P_T obj_i;// '<S312>/SinkBlock'
    ...
    ros_slroscpp_internal_block_S_T obj_bh;// '<S325>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_fx;// '<S324>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_h;// '<S323>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_oz;// '<S322>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_mt;// '<S321>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_hb;// '<S320>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_hd;// '<S315>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_df;// '<S307>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_cs;// '<S305>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_hh;// '<S234>/SourceBlock'
    ros_slroscpp_internal_block_S_T obj_k4;// '<S233>/SourceBlock'
    ...
    real_T UD_DSTATE;                  // '<S274>/UD'
    real_T DiscreteTransferFcn1_states;// '<S239>/Discrete Transfer Fcn1'
    real_T Delay_DSTATE_i;             // '<S263>/Delay'
    real_T Delay_DSTATE_k;             // '<S135>/Delay'
    real_T Delay_DSTATE_a[8];          // '<S141>/Delay'
    real_T mv_Delay_DSTATE[88];        // '<S211>/mv_Delay'
    real_T x_Delay_DSTATE[143];        // '<S211>/x_Delay'
    real_T slack_delay_DSTATE;         // '<S211>/slack_delay'
    real_T last_mv_DSTATE[8];          // '<S178>/last_mv'
    real_T Delay1_DSTATE[88];          // '<S140>/Delay1'
    real_T UD_DSTATE_i[6];             // '<S174>/UD'
    real_T last_mv_DSTATE_f[8];        // '<S144>/last_mv'
    ...
    int32_T clockTickCounter;          // '<S141>/Pulse Generator'
    int32_T clockTickCounter_g;        // '<S140>/Pulse Generator'
    ...
    boolean_T DelayInput1_DSTATE;      // '<S310>/Delay Input1'
    ...
    boolean_T icLoad;                  // '<S211>/mv_Delay'
    boolean_T icLoad_a;                // '<S211>/x_Delay'
    boolean_T icLoad_j;                // '<S211>/slack_delay'
    boolean_T Memory_PreviousInput[252];// '<S178>/Memory'
    boolean_T Memory_PreviousInput_g[252];// '<S144>/Memory'
  ...
  struct P_proc_control_T {
    ...
    real_T binv[48];                   // Variable: binv
                                          //  Referenced by: '<S139>/MATLAB System'
    ...
    real_T LastPcov_InitialCondition_d[625];// Expression: lastPcov
                                               //  Referenced by: '<S178>/LastPcov'

    real_T u_scale_Gain_i[8];          // Expression: MVscale
                                          //  Referenced by: '<S178>/u_scale'
    ...
    real_T useq_scale_Gain[88];        // Expression: MVscale(:,ones(1,p+1))'
                                          //  Referenced by: '<S178>/useq_scale'

    real_T useq_scale1_Gain[143];      // Expression: Yscale(:,ones(1,p+1))'
                                          //  Referenced by: '<S178>/useq_scale1'
    ...
    real_T einit_zero_Value;           // Expression: zeros(1,1)
                                          //  Referenced by: '<S209>/e.init_zero'
    ...
    real_T TSamp_WtEt_n;               // Computed Parameter: TSamp_WtEt_n
                                          //  Referenced by: '<S274>/TSamp'

    real_T DiscreteTransferFcn1_NumCoef_kc[2];// Expression: [physics.thruster.a1 0 ]
                                                 //  Referenced by: '<S239>/Discrete Transfer Fcn1'

    real_T DiscreteTransferFcn1_DenCoef_k[2];// Expression: [1  physics.thruster.b0]
                                                //  Referenced by: '<S239>/Discrete Transfer Fcn1'
    ...
    int32_T FixedHorizonOptimizer_Ndis;// Expression: Ndis
                                          //  Referenced by: '<S172>/FixedHorizonOptimizer'

    int32_T FixedHorizonOptimizer_Ndis_d;// Expression: Ndis
                                            //  Referenced by: '<S206>/FixedHorizonOptimizer'
    ...
    boolean_T Merge_3_InitialOutput;// Computed Parameter: Merge_3_InitialOutput
                                       //  Referenced by: '<S9>/Merge'
 ...
 private:
  ...
  void proc_control_qrFactor_3bJrEoRT(const real_T A[169], real_T S[169], const
    real_T Ns[39]);
  real_T proc_control_xnrm2_5AIjl0N4(int32_T n, const real_T x[30], int32_T ix0);
  void proc_control_xgemv_tqY1LJLU(int32_T m, int32_T n, const real_T A[30],
    int32_T ia0, const real_T x[30], int32_T ix0, real_T y[2]);
  void proc_control_xgerc_QhQfjc9Y(int32_T m, int32_T n, real_T alpha1, int32_T
    ix0, const real_T y[2], real_T A[30], int32_T ia0);
  void proc_control_qrFactor_wYNAcj6d(const real_T A[26], const real_T S[169],
    const real_T Ns[4], real_T b_S[4]);
  real_T proc_control_xnrm2_JsSmQP8R(int32_T n, const real_T x[195], int32_T ix0);
  void proc_control_xgemv_lsAhWhfs(int32_T m, int32_T n, const real_T A[195],
    int32_T ia0, const real_T x[195], int32_T ix0, real_T y[13]);
  void proc_control_xgerc_ARvWX7cB(int32_T m, int32_T n, real_T alpha1, int32_T
    ix0, const real_T y[13], real_T A[195], int32_T ia0);
  void proc_control_qrFactor_CnAcI93P(const real_T A[169], real_T S[169], const
    real_T Ns[26]);
  ...
  void proc_con_AUV7QuatJacobianMatrix(const real_T in1[13], real_T Anqv[169]);
  ...
  void proc_control_AUV7QuatSimFcn(const real_T in1[13], const real_T in2[8],
    real_T out1[13]);
  ...
  void AUV7QuatJacobianMatrix_nTvSBp_d(const real_T in1[13], real_T Anqv[169]);
  void proc_co_AUV7QuatSimFcn_AMXO4i32(const real_T in1[13], const real_T in2[8],
    real_T out1[13]);
  void proc_co_stateEvolution_7mRMr5Nb(const real_T X[143], const real_T U[88],
  ...
  void proc_control_outputBounds_p(const real_T runtimedata_OutputMin[130],
    ...
    real_T c_data[], int32_T c_size[2]);
  void proc_co_stateEvolution_Hv4SATKs(const real_T X[143], const real_T U[88],
    real_T c[130]);
  ...
  void proc_co_AUV7QuatPerturbedSimFcn(const real_T in1[13], const real_T in2[6],
    const real_T in3[8], real_T out1[13]);
...
//  Block '<S144>/Floor' : Unused code path elimination
//  Block '<S144>/Floor1' : Unused code path elimination
...
//  Block '<S144>/last_x' : Unused code path elimination
//  Block '<S171>/Vector Dimension Check' : Unused code path elimination
//  Block '<S144>/useq_scale' : Unused code path elimination
//  Block '<S144>/useq_scale1' : Unused code path elimination
//  Block '<S142>/m_zero' : Unused code path elimination
//  Block '<S142>/p_zero' : Unused code path elimination
//  Block '<S136>/Scope' : Unused code path elimination
//  Block '<S137>/Delay Input1' : Unused code path elimination
//  Block '<S137>/FixPt Relational Operator' : Unused code path elimination
//  Block '<S133>/Display' : Unused code path elimination
//  Block '<S174>/Data Type Duplicate' : Unused code path elimination
//  Block '<S178>/Floor' : Unused code path elimination
//  Block '<S178>/Floor1' : Unused code path elimination
...
//  Block '<S178>/last_x' : Unused code path elimination
//  Block '<S205>/Vector Dimension Check' : Unused code path elimination
//  Block '<S176>/m_zero' : Unused code path elimination
//  Block '<S176>/p_zero' : Unused code path elimination
...
//  Block '<S209>/mv.init_zero' : Unused code path elimination
//  Block '<S209>/x.init_zero' : Unused code path elimination
...
//  Block '<S300>/Matrix Concatenate' : Unused code path elimination
//  Block '<S300>/Scope' : Unused code path elimination
//  Block '<S300>/Scope1' : Unused code path elimination
//  Block '<S300>/Scope2' : Unused code path elimination
//  Block '<S300>/Scope3' : Unused code path elimination
//  Block '<S300>/Selector' : Unused code path elimination
//  Block '<S300>/Selector5' : Unused code path elimination
//  Block '<S300>/Selector6' : Unused code path elimination
//  Block '<S300>/Selector7' : Unused code path elimination
//  Block '<S300>/Selector8' : Unused code path elimination
//  Block '<S300>/Sum' : Unused code path elimination
//  Block '<S300>/e angulars rates' : Unused code path elimination
//  Block '<S300>/e position' : Unused code path elimination
//  Block '<S300>/e quaternion' : Unused code path elimination
//  Block '<S300>/e velocity' : Unused code path elimination
...
//  Block '<S144>/Reshape2' : Reshape block reduction
//  Block '<S144>/Reshape3' : Reshape block reduction
//  Block '<S144>/Reshape4' : Reshape block reduction
//  Block '<S144>/Reshape5' : Reshape block reduction
//  Block '<S178>/Reshape' : Reshape block reduction
//  Block '<S178>/Reshape1' : Reshape block reduction
//  Block '<S178>/Reshape2' : Reshape block reduction
//  Block '<S178>/Reshape3' : Reshape block reduction
//  Block '<S178>/Reshape4' : Reshape block reduction
//  Block '<S178>/Reshape5' : Reshape block reduction
//  Block '<S210>/Reshape1' : Reshape block reduction
//  Block '<S210>/mo or x Conversion' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion1' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion10' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion11' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion12' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion13' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion14' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion15' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion16' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion17' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion18' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion19' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion2' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion3' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion4' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion5' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion6' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion7' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion8' : Eliminate redundant data type conversion
//  Block '<S210>/mo or x Conversion9' : Eliminate redundant data type conversion
//  Block '<S211>/reshape_mv' : Reshape block reduction
...
//  '<S137>' : 'proc_control/Subsystem Controller/Controller list/Detect Change'
//  '<S138>' : 'proc_control/Subsystem Controller/Controller list/IDLE'
//  '<S139>' : 'proc_control/Subsystem Controller/Controller list/JoyStick OpenLoop'
//  '<S140>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion '
//  '<S141>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)'
//  '<S142>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller'
//  '<S143>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Bus2Mux'
//  '<S144>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC'
//  '<S145>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check'
//  '<S146>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check A'
//  '<S147>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check B'
//  '<S148>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check C'
//  '<S149>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check D'
//  '<S150>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check DX'
//  '<S151>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check U'
//  '<S152>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check X'
//  '<S153>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check Y'
//  '<S154>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check1'
//  '<S155>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Matrix Signal Check2'
//  '<S156>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check'
//  '<S157>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check1'
//  '<S158>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check2'
//  '<S159>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check3'
//  '<S160>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check4'
//  '<S161>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check5'
//  '<S162>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check6'
//  '<S163>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check7'
//  '<S164>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Preview Signal Check8'
//  '<S165>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Scalar Signal Check'
//  '<S166>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Scalar Signal Check1'
//  '<S167>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Scalar Signal Check2'
//  '<S168>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Vector Signal Check'
//  '<S169>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Vector Signal Check1'
//  '<S170>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/MPC Vector Signal Check6'
//  '<S171>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/moorx'
//  '<S172>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/optimizer'
//  '<S173>' : 'proc_control/Subsystem Controller/Controller list/Adaptive MPC quaternion /Adaptive MPC Controller/MPC/optimizer/FixedHorizonOptimizer'
//  '<S174>' : 'proc_control/Subsystem Controller/Controller list/JoyStick OpenLoop/Discrete Derivative'
//  '<S175>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /Bus2Mux'
//  '<S176>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller'
//  '<S177>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /MATLAB Function2'
//  '<S178>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC'
//  '<S179>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check'
//  '<S180>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check A'
//  '<S181>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check B'
//  '<S182>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check C'
//  '<S183>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check D'
//  '<S184>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check DX'
//  '<S185>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check U'
//  '<S186>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check X'
//  '<S187>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check Y'
//  '<S188>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check1'
//  '<S189>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Matrix Signal Check2'
//  '<S190>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check'
//  '<S191>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check1'
//  '<S192>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check2'
//  '<S193>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check3'
//  '<S194>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check4'
//  '<S195>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check5'
//  '<S196>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check6'
//  '<S197>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check7'
//  '<S198>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Preview Signal Check8'
//  '<S199>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Scalar Signal Check'
//  '<S200>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Scalar Signal Check1'
//  '<S201>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Scalar Signal Check2'
//  '<S202>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Vector Signal Check'
//  '<S203>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Vector Signal Check1'
//  '<S204>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/MPC Vector Signal Check6'
//  '<S205>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/moorx'
//  '<S206>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/optimizer'
//  '<S207>' : 'proc_control/Subsystem Controller/Controller list/LTV MPC quaternion /LTV MPC Controller/MPC/optimizer/FixedHorizonOptimizer'
//  '<S208>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Bus2Mux1'
//  '<S209>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller'
//  '<S210>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC'
//  '<S211>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/xmvs_router'
//  '<S212>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check'
//  '<S213>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check1'
//  '<S214>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check10'
//  '<S215>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check11'
//  '<S216>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check12'
//  '<S217>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check13'
//  '<S218>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check14'
//  '<S219>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check15'
//  '<S220>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check16'
//  '<S221>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check3'
//  '<S222>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check4'
//  '<S223>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check5'
//  '<S224>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check6'
//  '<S225>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check7'
//  '<S226>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check8'
//  '<S227>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Preview Signal Check9'
//  '<S228>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Scalar Signal Check1'
//  '<S229>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Scalar Signal Check2'
//  '<S230>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Vector Signal Check1'
//  '<S231>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/MPC Vector Signal Check11'
//  '<S232>' : 'proc_control/Subsystem Controller/Controller list/Quaternion Non linear MPC (Not for codegen)/Nonlinear MPC Controller/MPC/NLMPC'
//  '<S233>' : 'proc_control/Subsystem Controller/MPC manager/Subscribe'
//  '<S234>' : 'proc_control/Subsystem Controller/MPC manager/Subscribe1'
//  '<S235>' : 'proc_control/Subsystem Controller/MPC manager/Subscribe/Enabled Subsystem'
//  '<S236>' : 'proc_control/Subsystem Controller/MPC manager/Subscribe1/Enabled Subsystem'
...
//  '<S309>' : 'proc_control/Subsystem Trajectory/SubsystemAuto/Blank Message5'
//  '<S310>' : 'proc_control/Subsystem Trajectory/SubsystemAuto/Detect Rise Positive'
//  '<S311>' : 'proc_control/Subsystem Trajectory/SubsystemAuto/MATLAB Function2'
//  '<S312>' : 'proc_control/Subsystem Trajectory/SubsystemAuto/Publish5'
...
//  '<S320>' : 'proc_control/Subsystem1/Subscribe1'
//  '<S321>' : 'proc_control/Subsystem1/Subscribe2'
//  '<S322>' : 'proc_control/Subsystem1/Subscribe3'
//  '<S323>' : 'proc_control/Subsystem1/Subscribe4'
//  '<S324>' : 'proc_control/Subsystem1/Subscribe5'
//  '<S325>' : 'proc_control/Subsystem1/startSim'
//  '<S326>' : 'proc_control/Subsystem1/Subscribe1/Enabled Subsystem'
//  '<S327>' : 'proc_control/Subsystem1/Subscribe2/Enabled Subsystem'
//  '<S328>' : 'proc_control/Subsystem1/Subscribe3/Enabled Subsystem'
//  '<S329>' : 'proc_control/Subsystem1/Subscribe4/Enabled Subsystem'
//  '<S330>' : 'proc_control/Subsystem1/Subscribe5/Enabled Subsystem'
//  '<S331>' : 'proc_control/Subsystem1/startSim/Enabled Subsystem'
