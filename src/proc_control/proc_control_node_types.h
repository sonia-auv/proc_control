...
// Custom Type definition for MATLAB Function: '<S228>/NLMPC'
...
// Custom Type definition for MATLAB Function: '<S285>/Predict'
#ifndef struct_cell_wrap_0_proc_control_node_T
#define struct_cell_wrap_0_proc_control_node_T

struct cell_wrap_0_proc_control_node_T
{
  real_T f1[8];
};

#endif                                // struct_cell_wrap_0_proc_control_node_T
...
#ifndef struct_robotics_slcore_internal_b_b4_T
#define struct_robotics_slcore_internal_b_b4_T

struct robotics_slcore_internal_b_b4_T
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
  cell_wrap_proc_control_node_T inputVarSize[4];
...
#endif                                // struct_robotics_slcore_internal_b_b4_T
...
#ifndef struct_emxArray_real_T_1x7_proc_cont_T
#define struct_emxArray_real_T_1x7_proc_cont_T

struct emxArray_real_T_1x7_proc_cont_T
{
  real_T data[7];
  int32_T size[2];
};

#endif                                // struct_emxArray_real_T_1x7_proc_cont_T

#ifndef struct_emxArray_real_T_3x6x3_proc_co_T
#define struct_emxArray_real_T_3x6x3_proc_co_T

struct emxArray_real_T_3x6x3_proc_co_T
{
  real_T data[54];
  int32_T size[3];
};

#endif                                // struct_emxArray_real_T_3x6x3_proc_co_T

#ifndef struct_s_AITQ9DUL6umkPt5yuMqsWH_proc_T
#define struct_s_AITQ9DUL6umkPt5yuMqsWH_proc_T

struct s_AITQ9DUL6umkPt5yuMqsWH_proc_T
{
  emxArray_real_T_1x7_proc_cont_T breaks;
  emxArray_real_T_3x6x3_proc_co_T coefs;
};

#endif                                // struct_s_AITQ9DUL6umkPt5yuMqsWH_proc_T

#ifndef struct_emxArray_real_T_1x5_proc_cont_T
#define struct_emxArray_real_T_1x5_proc_cont_T

struct emxArray_real_T_1x5_proc_cont_T
{
  real_T data[5];
  int32_T size[2];
};

#endif                                // struct_emxArray_real_T_1x5_proc_cont_T

#ifndef struct_f_cell_wrap_proc_control_node_T
#define struct_f_cell_wrap_proc_control_node_T

struct f_cell_wrap_proc_control_node_T
{
  emxArray_real_T_1x5_proc_cont_T f1;
};

#endif                                // struct_f_cell_wrap_proc_control_node_T

#ifndef struct_emxArray_real_T_9x3_proc_cont_T
#define struct_emxArray_real_T_9x3_proc_cont_T

struct emxArray_real_T_9x3_proc_cont_T
{
  real_T data[27];
  int32_T size[2];
};

#endif                                // struct_emxArray_real_T_9x3_proc_cont_T

#ifndef struct_g_cell_wrap_proc_control_node_T
#define struct_g_cell_wrap_proc_control_node_T

struct g_cell_wrap_proc_control_node_T
{
  emxArray_real_T_9x3_proc_cont_T f1;
};

#endif                                // struct_g_cell_wrap_proc_control_node_T
...
#ifndef struct_emxArray_s_AITQ9DUL6umkPt5yuM_T
#define struct_emxArray_s_AITQ9DUL6umkPt5yuM_T

struct emxArray_s_AITQ9DUL6umkPt5yuM_T
{
  s_AITQ9DUL6umkPt5yuMqsWH_proc_T data[3];
  int32_T size;
};

#endif                                // struct_emxArray_s_AITQ9DUL6umkPt5yuM_T
